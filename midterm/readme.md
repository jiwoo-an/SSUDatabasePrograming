...
<h3>4. 사용한 웹 서버: 리눅스와 그 안에서 돌아가는 Apache</h3>
        리눅스를 웹 서버 OS로 선택한 이유:<br/>
        * 윈도우보다 보안성이 높다<br/>
        * 윈도우가 유료인 반면 리눅스OS는 무료이다.<br/>
        * 리눅스는 처리 속도도 윈도우보다 빠르다.<br/>
        * 위와 같은 이유들로 인해 리눅스OS의 서버가 회사에서 Windows OS보다 서버로서 더 많이 사용된다.<br/>
